...
def argparsing():
  parser = argparse.ArgumentParser(description='BiX-NAS Phase1 training / Retraining')
  parser.add_argument('--Phase1', action='store_true', default=False, help='BiX-NAS Phase1 training / Retraining?')
